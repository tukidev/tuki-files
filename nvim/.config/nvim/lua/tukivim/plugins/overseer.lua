import("overseer", function(overseer)
	overseer.setup({
		...
		task_list = {
			...
			max_width = { 100, 0.2 }, -- "the lesser of 100 columns or 20% of total"
			min_width = { 40, 0.1 }, -- "the greater of 40 columns or 10% of total"
		...
		-- :help overseer.actions
		actions = {},

		-- floating window used for task templates that require input
		-- floating window used for editing tasks
		form = {
			border = "rounded",
			zindex = 40,
			min_width = 80,
