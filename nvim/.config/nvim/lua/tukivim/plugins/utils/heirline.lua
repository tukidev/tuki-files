-- Setup components for statusline, bufferline, winbar and statuscolumn
-- SEE: https://github.com/anuvyklack/dotfiles/blob/main/roles/neovim/files/lua/anuvyklack/heirline/init.lua
...
local theme = require("tukivim.plugins.utils.colorschemes.catppuccin.heirline")
...
do
  ...
  do
    ...
    local ActiveModeIndicator = {
      ...
      heirline.surround(
        { icons.powerline.left_rounded, icons.powerline.right_rounded },
        function(self) return hl.Mode[self.mode].bg end, -- color
        {
          {
            fallthrough = false,
            ReadOnly,
