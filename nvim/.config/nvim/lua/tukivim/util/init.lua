...
---@class tukivim.util: LazyUtilCore
---@field c TukiVimCore
---@field lsp tukivim.util.lsp
---@field toggle tukivim.util.toggle
local M = {}

M.lsp = require("tukivim.util.lsp")
M.toggle = require("tukivim.util.toggle")
