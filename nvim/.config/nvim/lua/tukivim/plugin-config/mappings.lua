...
function R.append_to_defaults(keymaps)
...
-- @param keymaps The table of key mappings containing a list per mode (normal_mode, insert_mode, ..)
function R.clear(keymaps)
  local default = R.get_defaults()
  for mode, mappings in pairs(keymaps) do
...
function R.set_keymaps(mode, key, val)
...
function R.load_mode(mode, keymaps)
  mode = mode_adapters[mode] or mode
  for k, v in pairs(keymaps) do
    R.set_keymaps(mode, k, v)
  end
end

-- Load key mappings for all provided modes
-- @param keymaps A list of key mappings for each mode
function R.load(keymaps)
  keymaps = keymaps or {}
  for mode, mapping in pairs(keymaps) do
    R.load_mode(mode, mapping)
  end
end

-- Load the default keymappings
function R.load_defaults()
  R.load(R.get_defaults())
  -- lvim.keys = {}
